...
async function addDeposit(txId) {
    try {
        ...
        for (let i in details) {
            ...
            const balanceMsg = [now, "Bitcoin deposit to " + address, qty, txId];
            ...
            await redis[w.minus + c][w.lpushAsync](w.email, JSON.stringify({
                ...
                html: '<p>Hello,<br/><br/>Your deposit of <b>' + amount + '</b> bitcoin has been credited to your account.<br/><br/>Transaction ID (TxID):' + txId + '<br/><br/>Regards</p>'
            }));
        }
    } catch (e) {
        console.log(e);
